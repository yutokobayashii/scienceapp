      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: const <Widget>[
            ...
            Text('''ユーザーが当サービスを利用をする際に\n氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることは一切ありません。
            '''),
            ...
            Text('''当サービスは、個人情報利用開始が当サービスの向上に必要と判断した場合に限り、\n個人情報の利用有無を変更するものとします。利用開始の変更を行った場合には、変更後の目的について、\n当サービス所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。
            '''),
